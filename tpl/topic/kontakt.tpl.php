                    <div class="container section">
                        ...
                        <div class="row bg-white">
                            ...
                            <div id="kontaktForm" class="col-sm-12 col-lg-6">
                                <h2>Schreiben Sie uns.</h2>
                                <form id="kontaktformular" action="<?php // action_page.php ?>" method="post">
                                    <div>
                                    ...
                                    <div>
                                        <input id="submitAbDamit" type="submit" value="Abschicken" />
                                    </div>
                                </form>
                            </div>
                        </div>
