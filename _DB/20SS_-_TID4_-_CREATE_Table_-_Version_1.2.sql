...
GRANT USAGE 						ON tid4_kuenstlerdb_20ss.* 											TO KunstKunde@'%' 				IDENTIFIED BY '$4zahlenderKunde$4';
GRANT USAGE 						ON tid4_kuenstlerdb_20ss.* 											TO KunstKunde@'localhost' 		IDENTIFIED BY '$4zahlenderKunde$4';
GRANT SELECT          			ON tid4_kuenstlerdb_20ss.Kuenstler  	TO KunstKunde@'%';
GRANT SELECT          			ON tid4_kuenstlerdb_20ss.Kunstwerk     TO KunstKunde@'%';
GRANT SELECT, UPDATE  			ON tid4_kuenstlerdb_20ss.Kontakt       TO KunstKunde@'%';
GRANT SELECT          			ON tid4_kuenstlerdb_20ss.Kontaktart   	TO KunstKunde@'%';
GRANT SELECT, UPDATE  			ON tid4_kuenstlerdb_20ss.Kunde  			TO KunstKunde@'%';
GRANT SELECT          			ON tid4_kuenstlerdb_20ss.Kategorie     TO KunstKunde@'%';
GRANT SELECT          			ON tid4_kuenstlerdb_20ss.eingeordnet   TO KunstKunde@'%';

GRANT SELECT          			ON tid4_kuenstlerdb_20ss.Kuenstler   	TO KunstKunde@'localhost';
GRANT SELECT          			ON tid4_kuenstlerdb_20ss.Kunstwerk     TO KunstKunde@'localhost';
GRANT SELECT, UPDATE  			ON tid4_kuenstlerdb_20ss.Kontakt       TO KunstKunde@'localhost';
GRANT SELECT          			ON tid4_kuenstlerdb_20ss.Kontaktart    TO KunstKunde@'localhost';
GRANT SELECT, UPDATE  			ON tid4_kuenstlerdb_20ss.Kunde         TO KunstKunde@'localhost';
GRANT SELECT          			ON tid4_kuenstlerdb_20ss.Kategorie     TO KunstKunde@'localhost';
GRANT SELECT          			ON tid4_kuenstlerdb_20ss.eingeordnet   TO KunstKunde@'localhost';


-- DROP USER KunstKuenster;
GRANT USAGE 						ON tid4_kuenstlerdb_20ss.* 											TO KunstKuenstler@'%' 			IDENTIFIED BY '$4zahlender$4Kuenstler$4';
GRANT USAGE 						ON tid4_kuenstlerdb_20ss.* 											TO KunstKuenstler@'localhost' IDENTIFIED BY '$4zahlender$4Kuenstler$4';
...
GRANT USAGE 						ON tid4_kuenstlerdb_20ss.* 											TO KunstLogin@'%' 				IDENTIFIED BY 'neuer$4zahlender$4Kunde$4';
GRANT USAGE 						ON tid4_kuenstlerdb_20ss.* 											TO KunstLogin@'localhost' 		IDENTIFIED BY 'neuer$4zahlender$4Kunde$4';
