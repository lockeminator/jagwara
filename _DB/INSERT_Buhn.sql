...
VALUES              (4004, @lid, '+49153-7281256', 'Bitte nur in den Normalen Geschäftszeiten anrufen, besser das Fax benutzen. Da mein Privat-Telefon auch mein Dinst-Telefon ist. Danke');

INSERT INTO Kontakt (Art_ID, Kunden_ID, Kontakt, Bemerkung)
VALUES              (4005, @lid, '03336-28126', 'Hier immer zu erreichen');
...
INSERT INTO Kontakt (Art_ID, Kunden_ID, Kontakt, Bemerkung)
VALUES              (4001, @lid, 'herbert.Schuster@gmx.de', 'Ein bis zwei mal die Woche schau ich rein.');

INSERT INTO Kontakt (Art_ID, Kunden_ID, Kontakt, Bemerkung)
VALUES              (4003, @lid, '030-894346', 'Monatg: 10-12 Uhr oder Donnerstag 8-16 Uhr');
...
INSERT INTO Kontakt (Art_ID, Kunden_ID, Kontakt, Bemerkung)
VALUES              ( 4001, @kunde_id, 'Achimstolz@gmail.com', 'Deutsch und Englisch. Antworte so schnell ich kann.');

INSERT INTO Kontakt (Art_ID, Kunden_ID, Kontakt, Bemerkung)
VALUES              ( 4002, @kunde_id, '0340-29616', 'Nur im Notfall, Bitte.');
...
VALUES (@kunde_id, 4001, 'Dune', './img/Kunst_Buhn/alternativDune.png', (1194*3), (1701*3), 22.50, '148.24.78.64', 1500, 'inspiriert von den Dune Werken', '12.10.1998');
...
VALUES                (4001, @kunde_id, 4002, 'Illuminatus', './img/Kunst_Buhn/Illuminatus.jpg', (350*3), (668*3), 11.50, '154.33.55.180', CURRENT_TIMESTAMP() ,'148.24.78.64', 750, 'inspiriert von den Illuminatus Werken', '6.05.1975');
...
INSERT INTO Kontakt (Art_ID, Kunden_ID, Kontakt, Bemerkung)
VALUES              ( 4001, @kunde_id, 'Marie@curie.fr', 'Frazösisch der alten Schule xP');

INSERT INTO Kontakt (Art_ID, Kunden_ID, Kontakt, Bemerkung)
VALUES              ( 4003, @kunde_id, '0720-65846854', 'Büro: MO 7-12\n      DI 8-16\n      MI geschlossen\n      DO 8-16\n      FR geschlossen');
...
INSERT INTO Kunstwerk (Kuenstler_ID, Kunstwerk_ID, Titel, Image, Hoehe, Breite, Preis, Einstell_IP, Gewicht, Beschreibung, Herstelldatum)
VALUES ( @kunde_id, 4003, 'Betend Hände', './img/Kunst_Buhn/Betende_Haende.jpg', (650*3), (575*3), 25.99, 'b3::123:7b2a', 3000, 'In Messing Gegossene Betende Hände von Alfred Dürer.', '15.02.2007');

INSERT INTO eingeordnet -- (Kunstwerk_ID, Kategorie_ID)
                      VALUES ( 4003, 119 );

INSERT INTO Kunstwerk (Kuenstler_ID, Kunstwerk_ID, Titel, Image, Hoehe, Breite, Preis, Einstell_IP, Gewicht, Beschreibung, Herstelldatum)
VALUES ( @kunde_id, 4004, 'Da Vinci Panzer', './img/Kunst_Buhn/Davinci_panzer.jpg', 3550, 8900, 279.00, 'b3::123:7b2a', 9550, 'Nachbau des Da Vinci Panzers aus Pleixglass und Blech', '23.03.2018');
